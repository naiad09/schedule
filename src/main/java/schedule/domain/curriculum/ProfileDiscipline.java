...
/**
 * Профильная дисциплина. Отражает специфические характеристики Общей дисциплины
 * в контексте данного Учебного плана. Определяет дисциплину и Кафедру, которая
 * будет эту дисциплину читать.
 */
@Entity
